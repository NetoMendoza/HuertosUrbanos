        ...
        @include('cliente.layouts.messages.notifications')
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">Actualizar Tipo Planta</span>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('tipo-plantas.update', $tipoPlanta->id_tipo_plan) }}"  role="form" enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            @csrf
