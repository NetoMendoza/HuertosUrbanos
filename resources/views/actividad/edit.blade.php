        ...
        @include('cliente.layouts.messages.notifications')
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">Actualizar Actividad</span>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('actividads.update', $actividad->id_acti) }}"  role="form" enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            @csrf
