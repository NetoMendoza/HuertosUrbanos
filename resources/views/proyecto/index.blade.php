                                ...
                                <tbody>
                                    @foreach ($proyectos as $proyecto)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('proyectos.destroy',$proyecto->id_proy) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('proyectos.show',$proyecto->id_proy) }}"><i class="fa fa-fw fa-eye"></i> Mostrar</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('proyectos.edit',$proyecto->id_proy) }}"><i class="fa fa-fw fa-edit"></i> Editar</a>
                                                    @csrf
                                                    @method('DELETE')
