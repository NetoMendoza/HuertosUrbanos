        ...
        @include('cliente.layouts.messages.notifications')
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">Actualizar Requerimiento</span>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('requerimientos.update', $requerimiento->id_requ) }}"  role="form" enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            @csrf
