        ...
        @include('cliente.layouts.messages.notifications')
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">Actualizar Parametro</span>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('parametros.update', $parametro->id_param) }}"  role="form" enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            @csrf
